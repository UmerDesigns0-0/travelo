  ...
  return (
    <div className="relative">
      ...
      <Dialog
        ...
        className="absolute outline-none z-50 top-16 right-0 md:top-2 md:right-2 lg:right-101 translate-y-1/2"
      >
        <div className="inset-0 flex w-full items-center justify-center p-4">
          <DialogPanel className="w-68 space-y-3 border bg-white p-8 rounded-lg shadow-lg">
