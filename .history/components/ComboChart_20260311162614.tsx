...
const ComboChart = ({ chartHeading, data, tooltipValue }: comboChartProps) => {
  const sampleData = [
    { name: "march 25", value: 1000 },
    { name: "march 28", value: 1288 },
    { name: "april 4", value: 800 },
    { name: "april 8", value: 400 },
    { name: "april 13", value: 1400 },
    { name: "april 17", value: 1200 },
    { name: "april 21", value: 1600 },
    { name: "april 24", value: 1100 },
  ];
  return (
