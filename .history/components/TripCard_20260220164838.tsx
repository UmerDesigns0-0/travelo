...
const TripCard = ({
  ...
  return (
    <Link
      ...
      className="trip-card"
    >
      <div className="overflow-hidden rounded-lg w-fit h-40">
        <img
          className="w-full h-full object-cover transform transition-transform duration-300 ease-in-out hover:scale-105 rounded-t-xl"
          src={imageUrl}
          alt={name}
        />
      </div>
