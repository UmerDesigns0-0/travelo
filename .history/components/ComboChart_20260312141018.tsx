...
const ComboChart = ({
  ...
  shape={(props: any) => {
    ...
    return (
      <g>
        {height > 20 && <rect x={x} y={y} width={width} height={segmentHeight} fill="#3b82f6" />}
        {height > 40 && <rect x={x} y={y + segmentHeight} width={width} height={segmentHeight} fill="#60a5fa" />}
        {height > 60 && <rect x={x} y={y + segmentHeight*2} width={width} height={segmentHeight} fill="#93c5fd" />}
      </g>
    );
  }}
/>
