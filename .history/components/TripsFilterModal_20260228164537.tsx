...
const TripsFilterModal = ({ currentSort, onSortChange }: TripsFilterModalProps) => {
  const sortOptions = [
    { label: "All Trips", value: "all_trips" },
  ...
  const [selectedSort, setSelectedSort] = useState<string | undefined>(currentSort);
          ...
          >
            ...
            <div className="p-8 pb-2 space-y-3">
              ...
              <div className="radio-input text-sm">
                ...
                {/* Scroll ONLY here */}
                <div className="max-h-44 overflow-y-auto pr-2 scrollbar">
                  {sortOptions.map((option) => (
                    <label
                      key={option.value}
                      className="label flex items-center gap-2 wrap-break-word"
                    >
                      <input
                        type="radio"
                        name="sort"
                        ...
                        className="accent-blue-500 min-w-4.25!"
                      />
                      {option.label}
                    </label>
                  ))}
