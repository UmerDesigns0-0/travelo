...
import { formatYAxisValue, pluralize, toPercentage } from "~/lib/myutils";
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data}>
              ...
              <XAxis
                ...
                tickLine={false}
                axisLine={false}
                // tickFormatter={(value) => value.slice(0, 3) + " " + value.slice(3, 6)}
              ...
              <YAxis
                ...
                tickLine={false}
                axisLine={false}
                tickFormatter={(value) => toPercentage(value, 100)}
                tick={{ fontSize: 12 }}
                width={40}
              />
              {/* <Legend /> */}
