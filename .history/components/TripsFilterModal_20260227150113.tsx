  ...
  return (
    <div className="relative">
      ...
      <Dialog
        ...
        className="absolute outline-none z-50 -top-10 md:-top-6 lg:-top-8 right-0 md:right-6 lg:right-10 translate-y-1/2"
      >
        ...
        <div className="inset-0 flex w-fit items-center justify-center p-4">
          <DialogPanel className="w-64 md:w-68 space-y-3 border bg-white p-8 backdrop-filter backdrop-blur-sm rounded-lg shadow-lg">
