          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              <defs>
                ...
                >
                  {/* near line */}
                  <stop offset="0%" stopColor="#95c2f5" stopOpacity={5} />

                  {/* middle */}
                  <stop offset="50%" stopColor="#dfeaf7" stopOpacity={3} />

                  {/* bottom */}
                  <stop offset="100%" stopColor="#edf2f7" stopOpacity={2} />
                </linearGradient>
              ...
              <Tooltip
              formatter={(value) => [`${formatYAxisValue(value as number)} Users`, ""]}
                contentStyle={{
                  borderRadius: "12px",
