...
const DashTripsTable = () => {
  const [trips, setTrips] = useState<{ trip?: string; interests?: string }[]>(
    [],
  );
      ...
      cell: ({ getValue }) => {
        ...
        return (
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-full line-clamp-1 bg-green-300 flex items-center justify-center text-sm font-medium text-white">
              {}
            </div>
            <span>{tripName}</span>
          </div>
