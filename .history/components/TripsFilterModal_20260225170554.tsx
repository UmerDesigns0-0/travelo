  ...
  return (
    <div className="relative">
      ...
      <Dialog
        ...
        className="absolute outline-none z-50 top-16 left-0 md:top-2 lg:top-0 md:right-6 lg:right-10 translate-y-1/2"
      >
        <div className="fixed inset-0" aria-hidden="true" onClick={() => setIsOpen(false)} />
        <div className="inset-0 flex w-auto items-center justify-center p-4">
          <DialogPanel className="pointer-events-auto w-64 md:w-68 space-y-3 border bg-white p-8 rounded-lg shadow-lg">
