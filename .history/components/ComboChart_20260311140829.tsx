...
const ComboChart = ({ chartHeading, data, tooltipValue, value }: comboChartProps) => {
  let label = typeof tooltipValue === "function" ? tooltipValue(value) : `${value} ${tooltipValue}`;
  return (
        ...
        <div className="h-50 w-full">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip
                formatter={(value) => [
                  `${formatYAxisValue(value as number)} ${label}`,
                ]}
                contentStyle={{
                  borderRadius: "12px",
