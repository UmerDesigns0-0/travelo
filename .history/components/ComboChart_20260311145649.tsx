...
const ComboChart = ({ chartHeading, data, tooltipValue }: comboChartProps) => {
  return (
    <div className="w-full mx-auto">
      <div className="rounded-2xl border-slate-200 bg-white p-6 shadow-sm dark:bg-slate-900">
        {chartHeading && (
        ...
        <div className="h-50 w-full outline-none">
            ...
            >
              ...
              <Tooltip
                formatter={(value) => {
                  ...
                  return [formatYAxisValue(count), label];
                }}
                contentStyle={{
                  borderRadius: "12px",
