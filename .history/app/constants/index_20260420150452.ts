...
// import { ReactComponent as UsersIcon } from "@/assets/icons/users.svg?react";
// import { ReactComponent as TripsIcon } from "@/assets/icons/itinerary.svg?react";
...
export const sidebarItems = (isAdmin: boolean) => [
  {
    id: 1,
    Icon: isAdmin ? MdHome : FaHouseLock,
    label: isAdmin ? "Dashboard" : "Dashboard (Admin Only)",
    href: "/dashboard",
  },
  {
    id: 2,
...
export const dashboardStats = {
  totalUsers: 1125,
  usersJoined: { thisMonth: 85, lastMonth: 120 },
  totalTrips: 342,
  tripsCreated: { thisMonth: 25, lastMonth: 30 },
  userRole: { total: 62, thisMonth: 32, lastMonth: 20 },
};
