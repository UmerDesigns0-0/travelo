    ...
    <main className="get-started">
      <section className="flex-center glassmorphism size-full px-6">
        <div className="get-started-card text-center">
          ...
          <button className="mt-4 md:w-md w-full bg-primary-500 text-white py-2 px-4 rounded-lg hover:bg-primary-500/90 transition duration-300 cursor-pointer" onClick={() => redirect("/trips")}>
            Get Started
          </button>
        </div>
      </section>
