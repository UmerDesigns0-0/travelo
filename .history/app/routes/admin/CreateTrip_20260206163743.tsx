      ...
      <section className="wrapper-lg">
        <form className="trip-form px-4 py-8 mb-14" onSubmit={handleSubmit}>
          <FieldSet>
            ...
            <button
              className="flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm w-full md:w-sm mx-auto py-3 rounded-md text-white cursor-pointer"
              type="submit"
              disabled={loading}
            >
              {" "}
              <img
                className={cn(`mr-1 size-4 mx-auto`, loading && "animate-spin")}
                src={
                  loading
