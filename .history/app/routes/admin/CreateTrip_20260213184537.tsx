        ...
        <form className="trip-form px-4 py-8 mb-14" onSubmit={handleSubmit}>
          <FieldSet>
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
              ...
              />
              <div className="col-span-1"><Maps selectedCountry={selectedCountry} /></div>
              
              <div>
                <button
                  className={cn(
                    `flex col-span-1 items-center justify-center gap-2 transition-colors duration-300 ease-in-out bg-blue-500 hover:bg-blue-600 text-sm w-full md:w-sm mx-auto py-3 rounded-md text-white cursor-pointer`,
                    loading &&
