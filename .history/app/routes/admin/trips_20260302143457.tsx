...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const sort =
    (url.searchParams.get("sort") as "" | "latest" | "oldest" | "all_trips") || "all_trips";
...
const Trips = () => {
  ...
  useEffect(() => {
    account.get().then(setCurrentUser).catch(() => {});
  }, []);
  ...
  return (
    <main className="all-users wrapper">
      ...
      <section className="mx-auto">
        ...
        <div className="flex text-dark-200 items-center gap-2 mb-4">
          <h2 className="text-2xl font-medium">Trips</h2>
        <h3 className="text-muted-foreground text-md">"{total} trips found"</h3></div>
