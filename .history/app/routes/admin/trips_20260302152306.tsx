...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const filter = (url.searchParams.get("filter") || "all") as "all" | "mine";
...
const Trips = () => {
  ...
  // Heading
  const [heading, setHeading] = useState("All Trips");
  if (currentSort === "my_trips") {
    setHeading("My Trips");
  } else if (currentSort === "latest") {
    setHeading("Latest Trips");
  } else if (currentSort === "oldest") {
    setHeading("Oldest Trips");
  } else if (currentSort === "latest" && currentUser) {
    setHeading("My Latest Trips");
  }
