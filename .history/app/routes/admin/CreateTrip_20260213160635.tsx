...
const CreateTrip = () => {
  ...
  const fieldErrors = {
    country: !formData.country ? "Please select a country." : null,
    duration: !formData.duration ? "Please enter a duration." : null,
    groupType: !formData.selectedItems.groupType ? "Please select a group type." : null,
    travelStyle: !formData.selectedItems.travelStyle ? "Please select a travel style." : null,
    interest: !formData.selectedItems.interest ? "Please select at least one interest." : null,
    budget: !formData.selectedItems.budget ? "Please select a budget range." : null,
  };
