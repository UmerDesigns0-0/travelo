...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const sort =
    (url.searchParams.get("sort") as "" | "latest" | "oldest" | "all_trips" | "my_trips") || undefined;
...
const Trips = () => {
  ...
  const heading = (() => {
    ...
    if (currentSort === "my_trips") return "My Trips";
    if (currentSort === "all_trips") return "All Trips";
