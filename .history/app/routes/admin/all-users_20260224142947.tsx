        ...
        <form className="max-w-md mb-4">
          ...
          <div className="relative">
            ...
            <input
              type="search"
              id="search"
              className="block w-full outline-none p-3 ps-9 border border-slate-400 text-heading text-sm rounded-md focus:ring-2 focus:ring-slate-400 shadow-xs placeholder:text-body"
              placeholder="Search"
