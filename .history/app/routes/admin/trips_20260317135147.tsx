...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const filter = (url.searchParams.get("sort") as "" | "all" | "mine") || undefined;
...
const Trips = () => {
  ...
  const heading = (() => {
    if (filter === "my_trips" && sort === "latest") return "My Newest Trips";
    if (filter === "my_trips" && sort === "oldest") return "My Oldest Trips";
    if (filter === "my_trips") return "My Trips";
