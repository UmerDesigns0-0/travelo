      ...
      <section className="wrapper-lg">
        <form className="trip-form px-4 mb-14" >
          <FieldSet>
            ...
            <button className="bg-blue-500 hover:bg-blue-600 text-sm w-full md:w-md mx-auto p-4 rounded-md text-white" type="submit" onClick={handleSubmit}>Generate</button>
          </FieldSet>
        </form>
      </section>
    </main>
