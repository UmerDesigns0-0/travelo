...
const Duration = ({label, placeholder, description, onChange, error, formData}: Inputs) => {
  ...
  return (
    <Field className="flex flex-col gap-1.5">
      ...
      <FieldDescription className="text-xs">
        {error && !formData ? <span className="text-red-500">Please enter a valid duration(between 1 and 365).</span> : description}
      </FieldDescription>
    </Field>
  );
};
