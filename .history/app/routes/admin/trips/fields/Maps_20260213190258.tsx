...
const Maps = ({ selectedCountry }: MapsProps) => {
  const getMapUrl = () => {
    if (!selectedCountry || !selectedCountry.coordinates) {
      return "https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d19714623.639426894!2d0!3d20!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s, with: '100%'";
    }
  ...
  return (
    <Field>
      <Label className="form-label">
        <p className="flex flex-col md:flex-row gap-1 items-start md:items-center">
