...
const Countries = ({ countries, onCountryChange, error, formData }: CountriesProps) => {
  return (
    <Field>
      ...
      <FieldDescription className="text-xs">
        {error && !formData ? <span className="text-red-500">error</span>: "Enter the name of the country you want to visit." }
