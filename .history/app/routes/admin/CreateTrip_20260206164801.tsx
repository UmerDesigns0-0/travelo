      ...
      <section className="wrapper-lg">
        <form className="trip-form px-4 py-8 mb-14" onSubmit={handleSubmit}>
          <FieldSet>
            ...
            {error && (
              <p className="text-red-500 text-sm mt-2 text-center transition duration-300 ease-in-out animate-[shake_0.5s_ease-in-out]">{error}</p>
            )}
            <button
              className="flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-sm w-full md:w-sm mx-auto py-3 rounded-md text-white cursor-pointer"
              type="submit"
              disabled={loading}
            >
              {" "}
